...
export function MarkerForm({ currentTime, songId, onAdd, onCancel }: MarkerFormProps) {
  ...
  return (
    <div className='flex flex-col gap-3 p-4 bg-slate-700 rounded-lg'>
      <p className='text-xs text-slate-400 font-mono'>
        Add marker at {currentTime.toFixed(2)}s
      </p>
      ...
      <input
        ...
        className='bg-slate-800 text-slate-200 text-sm rounded px-3 py-2 outline-none
      ...
      <div className='flex gap-2 justify-end'>
        ...
        <button
          ...
          className='px-3 py-1 text-sm bg-indigo-500 hover:bg-indigo-400
